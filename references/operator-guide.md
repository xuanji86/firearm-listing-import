...
**正常情况你什么都不用做。** POS 会自己去把 GunBroker 上那条 listing 结束掉，
防止同一把枪被卖两次。

但要留意 AI 助手的回话：如果它提到 **"pending_manual"**、或者说"这把枪在
GunBroker 上还能被买走"，那就是**没自动结束成功**——这时候必须有人立刻登录
GunBroker 手动结束那条 listing。**这一条最要紧**：慢一步就可能把已经卖掉的枪
再卖一次。
